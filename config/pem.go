...
func LoadPem() (err error) {
	var err1, err2 error
	// JWT private key
	AppPem.JwtPrivateKey, err1 = helpers.ReadFileContentToString("build/pem/jwt_private.pem")
	if err1 != nil {
		helpers.Logger.Warn(
	...
	// JWT public key
	AppPem.JwtPublicKey, err2 = helpers.ReadFileContentToString("build/pem/jwt_public.pem")
	if err2 != nil {
		helpers.Logger.Warn(
