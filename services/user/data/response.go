...
type UserResponse struct {
	...
	Language       string           `json:"language" required:"false" doc:"Language code with 2 letters"`
	UserInfo       UserInfoResponse `json:"userInfo" required:"false" doc:"Additional user info(e.g. address, first name, last name, ...)" `
	Mfa            MFAResponse      `json:"mfa" required:"false" doc:"Multiple factor authenticator enabled by the user"`
}
